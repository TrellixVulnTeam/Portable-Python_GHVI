...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'clang -shared -m32 -L/tools/deps/lib -L/tools/deps/libedit/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -m32 -fPIC -I/tools/deps/include '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-m32 -fPIC -I/tools/deps/include '
 ...
 'CONFIGURE_CFLAGS_NODIST': '-flto -g -std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-m32 -fPIC -I/tools/deps/include '
                       '-I/tools/deps/include/ncursesw '
                       '-I/tools/deps/libedit/include',
 'CONFIGURE_LDFLAGS': '-m32 -L/tools/deps/lib -L/tools/deps/libedit/lib',
 'CONFIGURE_LDFLAGS_NODIST': '-flto -g',
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                "'--host=i686-unknown-linux-gnu' '--prefix=/install' "
                ...
                "'host_alias=i686-unknown-linux-gnu' 'CC=clang' 'CFLAGS=-m32 "
                '-fPIC -I/tools/deps/include -I/tools/deps/include/ncursesw '
                "-I/tools/deps/libedit/include' 'LDFLAGS=-m32 "
                "-L/tools/deps/lib -L/tools/deps/libedit/lib' 'CPPFLAGS=-m32 "
                '-fPIC -I/tools/deps/include -I/tools/deps/include/ncursesw '
                "-I/tools/deps/libedit/include'",
 'CONFINCLUDEDIR': '/install/include',
 'CONFINCLUDEPY': '/install/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.10.3/coverage.info',
 'COVERAGE_REPORT': '/build/Python-3.10.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -m32 -fPIC -I/tools/deps/include '
             '-I/tools/deps/include/ncursesw -I/tools/deps/libedit/include',
 'CXX': 'clang++',
 ...
 'LDFLAGS': '-m32 -L/tools/deps/lib -L/tools/deps/libedit/lib',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.10.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'clang -shared -m32 -L/tools/deps/lib -L/tools/deps/libedit/lib',
 'LDVERSION': '3.10',
 'LIBC': '',
 ...
 'LIBPL': '/install/lib/python3.10/config-3.10-i386-linux-gnu',
 'LIBPYTHON': '',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.10.3 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.10.3/`cat pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_i386-linux-gnu '
                     'python3.10',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -m32 -fPIC '
                   ...
                   '-I./Include/internal -I. -I./Include -m32 -fPIC '
                   '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                   '-I/tools/deps/libedit/include -fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-m32 -L/tools/deps/lib -L/tools/deps/libedit/lib -flto -g',
 'PY_CPPFLAGS': '-I. -I./Include -m32 -fPIC -I/tools/deps/include '
                '-I/tools/deps/include/ncursesw -I/tools/deps/libedit/include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-m32 -L/tools/deps/lib -L/tools/deps/libedit/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.10.3',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.10.3 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.10.3 ./python '
 ...
 'abs_builddir': '/build/Python-3.10.3',
 'abs_srcdir': '/build/Python-3.10.3',
